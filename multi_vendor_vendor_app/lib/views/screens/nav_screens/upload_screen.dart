                ...
                onTap: () async {
                  if (_formKey.currentState!.validate()) {
                    ...
                    if (productDescription.isEmpty) {
                      showSnackBar(content: "Please enter product description");
                      return;
                    }

                    if (vendorId.isEmpty || fullName.isEmpty) {
                      showSnackBar(
                        content:
                            "Vendor information missing. Please login again",
                      );
                      return;
                    }
                    ...
                    await _productController
                        ...
                        .whenComplete(() {
                          ...
                          selectedSubCategory = null;
                          //clear all textfield values as we dont use text field controller
