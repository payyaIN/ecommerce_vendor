      ...
      body: Column(
        children: [
                        ...
                        children: [
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            "\$${widget.orderModel.productPrice.toStringAsFixed(2)}",
                                            style: GoogleFonts.montserrat(
                                              fontSize: 15,
                          ...
                          Positioned(
                            ...
                            child: Container(
                              ...
                              clipBehavior: Clip.antiAlias,
                              decoration: BoxDecoration(
                                color: widget.orderModel.delivered == true
                                    ? const Color(0xFF3C55EF)
                                    : widget.orderModel.processing == true
                                    ? Colors.purple
                                    : Colors.red,
                              ...
                              child: Stack(
                                ...
                                children: [
                                  Positioned(
                                    ...
                                    top: 2,
                                    child: Text(
                                      widget.orderModel.delivered == true
                                          ? "Delivered"
                                          : widget.orderModel.processing == true
                                          ? "Processing"
                                          : "Cancelled",
          ...
          Padding(
            ...
            child: Container(
              width: 336,
              height: widget.orderModel.delivered == true ? 170 : 120,
              decoration: BoxDecoration(
                color: Colors.white,
                border: Border.all(color: const Color(0xFFEFF0F2)),
              ),
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "${widget.orderModel.state} ${widget.orderModel.city} ${widget.orderModel.locality}",
