...
import 'package:multi_ventor_store/models/usermodel.dart';
import 'package:multi_ventor_store/services/mange_response.dart';
import 'package:multi_ventor_store/utils/constants/global_variables.dart';
import 'package:multi_ventor_store/utils/constants/imports.dart';
import 'package:multi_ventor_store/utils/constants/navigation_method.dart';
  ...
  Future<void> signupUser({
    ...
    try {
      ...
      http.Response response =
          await http.post(url, headers: header, body: user.toJson());
